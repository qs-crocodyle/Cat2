...
local card = {
    ...
    id = "druid_wrath_lunar_peak",
    -- 界面中显示的卡片标题。
    name = "愤怒（夜至）",
    -- 卡片标题下方显示的简短说明。
    description = "夜至无法触发日蚀，施放自然伤害法术",
    -- 预留给后续详情面板或 Tooltip 的完整功能说明。
    details = "夜至无法触发日蚀，施放自然伤害法术。需要存在有效目标；流程中存在“愤怒切换神像”被动卡时，会在施放前尝试切换对应神像。成功执行时会阻断本轮后续卡片。",
