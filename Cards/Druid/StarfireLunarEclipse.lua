...
local card = {
    ...
    id = "druid_starfire_lunar_eclipse",
    -- 界面中显示的卡片标题。
    name = "星火术（月蚀）",
    -- 卡片标题下方显示的简短说明。
    description = "月蚀增伤时，施放高伤害奥术法术",
    -- 预留给后续详情面板或 Tooltip 的完整功能说明。
    details = "月蚀增伤时，施放高伤害奥术法术。需要存在有效目标；流程中存在“星火术切换神像”被动卡时，会在施放前尝试切换对应神像。成功执行时会阻断本轮后续卡片。",
...
local function EquipConfiguredIdol(context)
    local desiredIdol = context and context.parameters and context.parameters.druidStarfireIdol
