...
local card = {
    id = "druid_combo_point_idol_5",
    name = "连击点神像（>五星）",
    description = "装备|cff6bc7e0{lowComboIdol}|r，5星装备|cff6bc7e0{highComboIdol}|r",
    details = "仅在猎豹形态下，根据当前目标的连击点切换神像：0至4个连击点默认使用凶猛神像，5个连击点默认使用撕裂神像。选择留空时对应连击点区间不切换。仅在公共冷却结束且未打开银行、拍卖行、邮箱或商人界面时操作装备；已经装备目标神像或背包中没有该神像时不会重复切换。成功换装时会阻断本轮后续卡片。",
    sort = 1001,
    category = "class",
