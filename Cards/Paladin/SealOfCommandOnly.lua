-- 命令圣印 技能卡片。
local card = {
    id = "paladin_seal_of_command_only",
    name = "命令圣印",
    description = "施放并保持命令圣印，不自动施放审判",
    details = "施放并保持命令圣印，本卡不自动施放审判。沿用圣印卡规则：启用维持审判卡时，先等待对应审判生效。成功执行时会阻断本轮后续卡片。",
    sort = 29,
    category = "class",
