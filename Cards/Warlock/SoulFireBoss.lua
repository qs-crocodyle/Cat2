-- 灵魂之火强敌卡：复制“灵魂之火”，仅增加强敌目标判断。
local card = {
    id = "warlock_soul_fire_boss",
    name = "灵魂之火 仅强敌时",
    description = "仅强敌且目标血量不低于|cff6bc7e0{minimumTargetHealth}|r时，施放灵魂之火",
    details = "仅强敌目标下，目标血量不低于卡片设定值且技能冷却完成时，施放灵魂之火；目标血量低于设定值时不会施放。默认最低目标血量为3000。需要存在有效目标；目标火焰免疫时不会施放。仅在技能可用时尝试执行。成功执行时会阻断本轮后续卡片。",
    sort = 40.05,
    category = "class",
    classes = {
        WARLOCK = 3,
