-- 破甲攻击强敌卡：复制“破甲攻击”，仅增加强敌目标门禁。
local card = {
    id = "warrior_sunder_armor_boss",
    name = "破甲攻击 仅强敌时",
    description = "怒气达到|cff6bc7e0{rageThreshold}|r时仅对强敌施放破甲攻击",
    details = "仅对强敌目标生效，怒气达到卡片设定值时无限施放破甲攻击，默认需要30怒气。需要存在有效目标。会检查当前资源。成功执行时会阻断本轮后续卡片。",
    sort = 20.5,
    category = "class",
    classes = {
        WARRIOR = 3,
