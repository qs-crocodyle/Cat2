-- 暴风雪（自己）技能卡片；具体执行逻辑待补充。
local card = {
    id = "mage_blizzard_self",
    name = "暴风雪（自己）",
    description = "以自己为施法位置使用|cff6bc7e0{spellRank}级|r暴风雪",
    details = "按卡片设定等级，以自己为施法位置使用暴风雪；默认动态使用当前已学习的最高等级，需UnitXP202607以上。成功执行时会阻断本轮后续卡片。",
    sort = 40.1,
    category = "class",
