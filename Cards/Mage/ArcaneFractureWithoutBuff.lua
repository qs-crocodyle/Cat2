-- 仅在没有奥术溃裂增益时施放奥术溃裂的技能卡片。
local card = {
    id = "mage_arcane_fracture_without_buff",
    name = "奥术溃裂（无溃裂增益时）",
    description = "没有奥术溃裂增益时，施放奥术溃裂",
    details = "玩家身上没有奥术溃裂增益且技能冷却完成时，施放奥术溃裂。需要存在有效目标；目标奥术免疫时不会施放。成功执行时会阻断本轮后续卡片。",
    sort = 21,
    category = "class",
    classes = {
        MAGE = 1,
