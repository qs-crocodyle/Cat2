...
local card = {
    ...
    details = "冷却时，施放烈焰震击。需要存在有效目标；目标火焰免疫时不会施放。流程中存在“震击切换图腾”被动卡且图腾名称非空时，仅在冷却结束前1.5秒且当前处于公共冷却前半段时预先换装，技能真正就绪后才施放。切换装备本身不会阻断流程。本联动只作用于原始烈焰震击卡，不影响其分支；技能成功执行时会阻断本轮后续卡片。",
    sort = 40,
    category = "class",
