...
local ShamanChainHeal = {}
local ShamanChainHealEffect = {}
local ShamanChainHealFactor = 0.7
local ShamanChainHealMaxLevel = 3

function card.RefreshRuntimeData()
    local healingPower = Cat2.CalculateTotalHealingPower()
    local tidalFocus = 1-Cat2.IsTalentLearned(3, 2)*0.01

    ShamanChainHeal[1] = 260*tidalFocus
    ShamanChainHealEffect[1] = 356+(healingPower*ShamanChainHealFactor)
    ShamanChainHeal[2] = 315*tidalFocus
    ShamanChainHealEffect[2] = 449+(healingPower*ShamanChainHealFactor)
    ShamanChainHeal[3] = 405*tidalFocus
    ShamanChainHealEffect[3] = 606+(healingPower*ShamanChainHealFactor)

    ShamanChainHealMaxLevel = Cat2.GetHighestRankOfSpell("治疗链")
end
